     ...
     <div class="app-content-body ">
        <div class="wrapper-md control" id="add">
          ...
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
              <a data-toggle="tab" href="#kcpz">课程配置</a>
            </li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="jhdl">
             ...
             <div class="tab-pane fade" id="kcpz">
            
            <div class="form-group">
							<label class="col-sm-2 control-label">签到免费下单</label>
								<div class="col-sm-9">
									<input type="text" class="layui-input" name="mfxd" value="<?=$conf['mfxd']?>" placeholder="多课程使用英文逗号分隔 例：1,2" required>
							</div>
						</div>
