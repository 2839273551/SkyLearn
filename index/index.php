...
<?php } ?>
      ...
      <div class="layui-side layui-side-menu">
       ...
       <ul class="layui-nav layui-nav-tree" lay-filter="layadmin-system-side-menu" id="LAY-system-side-menu">
  <li data-name="home" class="layui-nav-item layui-nav-itemed">
    ...
    <dl class="layui-nav-child">
      <dd>
        <a lay-href="main">个人综合</a>
      </dd>
      <dd>
        <a lay-href="home">实时公告</a>
      </dd>
    </dl>
        ...
        <dd>
            <i class="layui-icon layui-icon-upload-circle"></i>  <a lay-href="addtj" >无查提交</a>
             ...
             <li data-name="list" class="layui-nav-item">
                        <a lay-href="list" lay-text="订单汇总" lay-tips="订单汇总" lay-direction="3">
  ...
  <dl class="layui-nav-child">
    <dd><a lay-href="userinfo">我的资料</a></dd>
    <dd><a lay-href="userlist">代理管理</a></dd>
    <dd><a lay-href="atest">最新上架</a></dd>
    <dd><a lay-href="atesa">下架专区</a></dd>
    <dd><a lay-href="rd">热度排行</a></dd>
    <dd><a lay-href="kcid">kcid对比</a></dd>
    <dd><a lay-href="dingdan">可用项目<span class="layui-badge layui-bg-orange">自己查询</span></a></dd>
    <dd><a lay-href="log">操作日志</a></dd>
    <dd><a lay-href="help">必看说明</a></dd>
    <dd><a lay-href="myprice">学习价格</a></dd>
    <dd><a lay-href="docking">串货对接</a></dd>
      <dd><a lay-href="pchangelist">价格变动</a></dd>
    <dd data-name="grid">
      <a href="javascript:;"><i class="layui-icon layui-icon-down"></i>充值方式<span class="layui-nav-more"></span></a>
      <dl class="layui-nav-child">
        <dd><a lay-href="pay">卡密充值</a></dd>
        <dd><a lay-href="charge">在线充值</a></dd>
      </dl>
    </dd>
  </dl>
</li>
            ...
            <li data-name="workorder" class="layui-nav-item">
                    ...
                    <li data-name="chati" class="layui-nav-item">
                        <a lay-href="chati" lay-text="题库查询" lay-tips="题库查询" lay-direction="3">
                    ...
                    <!--  <li data-name=" chatgpt" class="layui-nav-item">-->
                    <!--    <a lay-href=" chatgpt" lay-text="AI助手" lay-tips="AI助手" lay-direction="3">-->
...
function calculateRuntime() {
    const start = new Date('2025-03-01T17:00:00'); // 开始时间
