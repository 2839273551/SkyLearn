  ...
  return ElegantVueRouter({
    ...
    onRouteMetaGen(routeName) {
      ...
      const routeMetaMap: Record<string, Partial<RouteMeta>> = {
        ...
        passwd: { title: '修改密码', hideInMenu: true },
        sjqy: { title: '上级迁移', hideInMenu: true },
        usernotice: { title: '设置公告', hideInMenu: true },
        smgz: { title: '通知频道', hideInMenu: true },
        adduser: { title: '添加代理', hideInMenu: true },
        usergj: { title: '修改费率', hideInMenu: true },
        jgjk: { title: '价格监控管理', hideInMenu: true, roles: ['R_SUPER'] },
        tjuser: { title: '强国录入账号', hideInMenu: true },
