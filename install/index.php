<?php
// Installation is permanently disabled once the lock file exists.
if (is_file(__DIR__ . DIRECTORY_SEPARATOR . 'install.lock')) {
    http_response_code(403);
    exit('Installation is locked.');
}
...
?>";
                                                    ...
                                                    }elseif(file_put_contents('../xm/config.php',$config)){
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    echo '<div class="alert alert-info"><font color="green">安装完成！<br>请使用安装时设置的管理员凭据登录后台</font><br/><br/><br/><hr/>更多设置选项请登录后台管理进行修改<font color="#FF0033">如果你的空间不支持本地文件读写，请自行在网站install目录建立 install.lock 文件！</font></div>';
                                                    ?>
                                                </div>
                                            </div>
